<?php
session_start();
//include $_SERVER['DOCUMENT_ROOT'] . '/functions/UrlShortener.php';
//include $_SERVER['DOCUMENT_ROOT'] . '/database/Connection.php';
//$short = new UrlShortener();
//$code = $short->generateCode(1);
//echo "http://kylebirch.info/$code";
//exit;
?>
        ...
        <form method="POST" action="functions/shorten.php">
            <div class="section group">
                <div class="col span_3_of_3">
                    <input type="url" id="input" name="url" class="input" placeholder="Enter a URL here" autofocus required>
                </div>
